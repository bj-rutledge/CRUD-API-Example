...
describe('Product', () => {
    ...
    it('should set default markup if provided markup is below 1.5', () => {
        const product = new Product(123, 50, 1.2, 80, false, 'Example Product', 'This is an example product.');
    ...
    it('should handle invalid arguments', () => {
        ...
        const invalidProduct = new Product('invalid', 'invalid', 'invalid', 'invalid', 'invalid', 'invalid', 'invalid');
